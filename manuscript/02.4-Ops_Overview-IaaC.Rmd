...
It is recommended to utilize infrastructure-as-code to deploy an ML platform. Popular tools for implementing IaC are for example Terraform, CloudFormation, and Ansible. [Chapter 6](#terraform) gives a more detailed description and a tutorial on how to use Infrastructure as code using *Terraform*.
