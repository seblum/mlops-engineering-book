...
*"MLOps Engineering: Building, Deploying, and Managing Machine Learning Workflows with Airflow and MLflow on Kubernetes"* is a comprehensive guide to building and deploying machine learning models using Airflow and MLflow on an Kubernetes cluster running in a cloud environment. The book is designed for Data Scientists, Data Engineers and DevOps practitioners who are looking to dive into the realm of machine learning operations (MLOps) and automate the deployment of their models in a production environment.
