...
![web-interface_dags](./images/03-Airflow/web-interface_dags.png)

![web-interface_dag-grid](./images/03-Airflow/web-interface_dag-grid.png)
...
```
![task-dependencies](./images/03-Airflow/task-dependencies.png "task-dependencies")
...
```
![task-dependencies_mixed](./images/03-Airflow/task-dependencies_mixed.png "task-dependencies_mixed")
...
```
![task-dependencies_upstream](./images/03-Airflow/task-dependencies_upstream.png "task-dependencies_upstream")
...
task_1.set_downstream(task_2)
```
![task-dependencies_wild](./images/03-Airflow/task-dependencies_wild.png "task-dependencies_wild")
