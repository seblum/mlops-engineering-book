...
![](./images/03-Airflow/web-interface_dags.png)

![](./images/03-Airflow/web-interface_dag-grid.png)
...
```
![](./images/03-Airflow/task-dependencies.png "task-dependencies")
...
```
![](./images/03-Airflow/task-dependencies_mixed.png "task-dependencies_mixed")
...
```
![](./images/03-Airflow/task-dependencies_upstream.png "task-dependencies_upstream")
...
task_1.set_downstream(task_2)
```
![](./images/03-Airflow/task-dependencies_wild.png "task-dependencies_wild")
