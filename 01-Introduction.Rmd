...
The goal of DevOps is to automate and streamline the process of building, testing, and deploying software to make the management of the software lifecycle as quick and efficient as possible. This can be achieved by using tools, such as *version control*, *continuous integration and delivery (CI/CD)*, and *monitoring and observability*, all of which are introduced in a later chapter (TODO: insert chapter).
