...
Deployment of Airflow and MLflow on an Kubernetes cluster using Terraform.

Chose AWS, Airflow, MLFlow, and Terraform why? Kubernetes for scalability.

Github Actions why?

All open source.
TODO
and hencefore the implementation of the previously introduced tools. A machine learning workflow using Airflow is set up on the deployed infrastructure, including data preprocessing, model training, and model deployment, as well as tracking the experiment and deploying the model into production using MLFlow. 
